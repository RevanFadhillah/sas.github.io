...
<nav class="navbar navbar-light ">
            ...
            <li class="nav-item">
                <a class="nav-link disabled text-dark" href="menu.php">Menu</a>
            </li>
            <li class="nav-item">
                <a class="nav-link disabled text-dark" href="Sejarah.php">Sejarah</a>
            </li>
            <li class="nav-item">
                <a class="nav-link disabled text-dark" href="Tokoh.php">Tokoh</a>
                </ul>
            </nav>
<div class="container">
    <h1>Daftar Tamu</h1>
